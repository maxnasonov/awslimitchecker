...
class _Route53Service(_AwsService):
    ...
    def find_usage(self):
        ...
        """
        self.limits['Health Checks']._add_current_usage(
            self.conn.get_health_check_count()['HealthCheckCount']
        )
    ...
    def get_limits(self):
        ...
        """
        limits['Health Checks'] = AwsLimit(
            'Health Checks',
            self,
            49,
            self.warning_threshold,
            self.critical_threshold,
            limit_type='AWS::Route53::HealthCheck',
        )
        self.limits = limits
        return limits
